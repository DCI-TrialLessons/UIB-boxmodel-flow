...
| ![Status](../../blob/badges/.github/badges/autograding/status2.svg) | Each section should contain a set of height and width |
| ![Status](../../blob/badges/.github/badges/autograding/status3.svg) | Each image should contain a set of height and width |
| ![Status](../../blob/badges/.github/badges/autograding/status4.svg) | Content inside the section tags should be Scrollable |

### Task 2

|                 Status                  | Check                                                                                    |
| :-------------------------------------: | :--------------------------------------------------------------------------------------- |
| ![Status](../../blob/badges/.github/badges/autograding/status5.svg) | Float css property should be present in styling |
